...
public class Day4 : ITaskRunner
{
    public void RunTheTask()
    {
        ...
        char [,] puzzleMatrix = new char[inputSplit[0].Length, inputSplit.Length];
    ...
    string input = @"MSMSMAXXAXXXXAXXAXMASMXSXMASMXMXMASMSSXASAMXSAMXXSAMXXMAMMSSMSSSMXSAMXXXXXSXSXSMSMMMMSXMASMMMSMSSSSMMMSAXSSSSSSXMASAMXMSSMMSMMMSAMSAMXAMAMXS
